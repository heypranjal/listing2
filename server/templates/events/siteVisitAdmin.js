...
function buildSiteVisitAdminEmail({ name, phone, email, property, preferredDate, preferredTime, message }) {
    ...
    <tr>
      <td align="center">
        <table class="email-wrapper" width="600" cellpadding="0" cellspacing="0"
          ...
          ${buildHeader('Site Visit Request')}
          <tr>
            <td style="background:#1a1a2e;padding:12px 40px;text-align:center;">
              <div style="display:inline-block;background:#c9a96e;border-radius:20px;
                           padding:5px 18px;font-size:11px;font-weight:700;
                           color:#1a1a2e;letter-spacing:2px;text-transform:uppercase;">
                Action Required
              </div>
            </td>
          </tr>
          <tr>
            <td class="email-body" style="padding:36px 40px;">
              <p style="font-size:14px;color:#444;margin:0 0 24px;">
                A client has requested a <strong style="color:#1a1a2e;">site visit</strong>.
                Please confirm their slot and coordinate accordingly.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                ${buildInfoRow('Preferred Date', preferredDate)}
                ${buildInfoRow('Preferred Time', preferredTime)}
                ${buildInfoRow('Request Received', receivedAt)}
              </table>
              ${message ? `
              <div style="margin-top:24px;padding:16px 20px;background:#f9f8f5;
                ...
                <div style="font-size:11px;color:#888;text-transform:uppercase;
                             letter-spacing:1px;margin-bottom:8px;">Additional Note</div>
...
module.exports = buildSiteVisitAdminEmail;
